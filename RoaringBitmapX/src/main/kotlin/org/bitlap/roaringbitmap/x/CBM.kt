...
class CBM : AbsBM, ComparableBM {
        ...
        this.also {
            if (bytes == null || bytes.isEmpty()) {
                ...
                DataInputStream(ByteArrayInputStream(bytes)).use { dis ->
                    checkExpression(dis.readInt() == Versions.CBM_VERSION_V1, msg = "Broken CBM bytes.")
    ...
    fun add(bucket: Int, dat: Int, count: Long): CBM = resetModify {
        checkExpression(count > 0, "CBM count should be greater than 0")
