package org.bitlap.roaringbitmap.insights;

/**
 * The purpose of this class it to help user decide
 * which {@link org.bitlap.roaringbitmap.RoaringBitmapWriter} heuristic to use.
 */
public class NaiveWriterRecommender {
  /**
   * Based on the statistics it applies expert rules
   * to help tuning the {@link org.bitlap.roaringbitmap.RoaringBitmapWriter}
   * @param s statistics
   * @return some message
   */
